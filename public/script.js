...
function trackMedalDate(type, participantName) {
  ...
  medalDates.push({ 
    date: today, 
    type,
    participant: participantName // Añadimos el nombre del participante
  });
...
function resetMedalDates() {
  if (confirm('¿Estás seguro de que quieres reiniciar el historial de Mejores Momentos? Esto no se puede deshacer.')) {
